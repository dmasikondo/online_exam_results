    ...
    <x-modal wire:model="show">   
      ...
      <div class="m-4 p-4">
        ...
        @if($showSuspendUserBtn)
            <button class="font-semibold text-indigo-500" wire:click="suspendUser" wire:loading.remove wire:target="suspendUser">
                Suspend User
            </button>
        @endif
        ...
        @if(!$showSuspendUserBtn)
            <button class="font-semibold text-indigo-500" wire:click="unsuspendUser" wire:loading.remove wire:target="unsuspendUser">
                Unuspend User
            </button>
        @endif
