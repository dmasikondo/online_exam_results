...
<div x-data="{show: false}" @click.away="show=false">
    ...
    <div x-show="show" {{$attributes->merge(['class'=>"text-left p-2 absolute w-40 mt-2 rounded bg-gradient-to-br from-yellow-50 via-white to-indigo-50 border z-50"])}}  style="display: none;">  
             {{$slot}}              
    </div>
</div>