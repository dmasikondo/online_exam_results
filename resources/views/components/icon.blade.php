@props(['name'])			
	{{-- user add --}}
	@if($name =='user-add')
		<svg {{$attributes(['class'=>"inline h-6 w-6"])}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
	...
	{{-- edit --}}
	@elseif($name=='edit')
		<svg  {{$attributes(['class'=>"inline h-5 w-5"])}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
		  <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
		  <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
		</svg>
	{{-- user remove --}}
	@elseif($name=='user-remove')	
		<svg {{$attributes(['class'=>"inline h-5 w-5"])}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
		  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7a4 4 0 11-8 0 4 4 0 018 0zM9 14a6 6 0 00-6 6v1h12v-1a6 6 0 00-6-6zM21 12h-6" />
		</svg>	
	{{-- cake --}}
	@elseif($name=='cake')	
		<svg {{$attributes(['class'=>"inline h-6 w-6 text-green-700"])}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
	...
	@elseif($name=='plus-circle')
		<svg {{$attributes(['class'=>"inline h-6 w-6"])}} xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
	...
	@elseif($name =='academic-cap')
		<svg {{$attributes(['class'=>"inline h-6 w-6 text-green-700"])}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
