...
class UserPolicy
{
     ...
     * Must belong to the IT Unit Dept
     *
     * @param  \App\Models\User  $user
     ...
     * User must be have either the  superadmin role or is the IT manager and not own account
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $model
     * @return \Illuminate\Auth\Access\Response|bool
    ...
    {
        return $user->id != $model->id && ($model->belongsTodepartmentOf('IT Unit')|| $model->hasRole('hod'));
    }
    ...
    /**
     * Determine whether the user canUpdate Self.
     * User must not own account
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $model
     * @return \Illuminate\Auth\Access\Response|bool
